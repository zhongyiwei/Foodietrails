...
//     }
    var $uses = array('Tour', 'Event','Cookingclass','Product','User','Feedback');

    function beforeFilter() {
        Security::setHash('sha1');
        $menus = $this->Tour->find('all');
        $this->set('menu', $menus);
        $this->Auth->allow('display', 'tourDetail', 'aboutCompany', 'contactUs', 'login', 'event_detail', 'checkout', 'logout', 'customerLogin', 'deleteCheckoutItem', 'customerPayment', 'existingCustomerLogin','check','confirmCheckout','sendEmail','sendSuccessful');
