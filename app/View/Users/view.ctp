...
<li><?php echo $this->Form->postLink(__('Delete This User'), array('action' => 'delete', $user['User']['id']), null, __('Are you sure you want to delete # %s?', $user['User']['user_first_name'])); ?> </li>
<?php
$this->end();
