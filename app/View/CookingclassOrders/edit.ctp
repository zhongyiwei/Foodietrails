...
<li><?php echo $this->Form->postLink(__('Delete this Order'), array('action' => 'delete', $this->Form->value('CookingclassOrder.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CookingclassOrder.id'))); ?></li>
<?php
$this->end();
