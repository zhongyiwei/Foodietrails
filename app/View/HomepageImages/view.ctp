...
<li><?php echo $this->Form->postLink(__('Delete This Image'), array('action' => 'delete', $homepageImage['HomepageImage']['id']), null, __('Are you sure you want to delete # %s?', $homepageImage['HomepageImage']['id'])); ?> </li>
<?php
$this->end();
