<div class="search">
    <div class="searchBorder">
        ...
        <div id="slideshow">
            <ul>
                <li><img src="img/Picture1.jpg" title = "Masala Trails" width="700" alt="Picture 1"/></li>
                <li><img src="img/Picture2.jpg" title = "Indian Trials" width="700" alt="Picture 2"/></li>
                <li><img src="img/Picture3.jpg" title = "Afriaca Trials" width="700" alt="Picture 3"/></li>
            </ul>
        </div>
    </div>
...
<table width="200" border="1">
    <tr>
        <td><div style="width: 720px" class="line">
                ...
                <div class="tourImage"> <img src="img/MT1.jpg"  height="125px" border="0"> </div>
                <div class="tourDetails"> <b>Country: </b>Australia <br>
