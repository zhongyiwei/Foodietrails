...
<li><?php echo $this->Form->postLink(__('Delete This Product'), array('action' => 'delete', $tour['Produt']['id']), null, __('Are you sure you want to delete # %s?', $product['Product']['id'])); ?> </li>
<?php
$this->end();
