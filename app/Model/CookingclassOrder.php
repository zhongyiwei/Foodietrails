...
class CookingclassOrder extends AppModel {
    ...
    public $validate = array(
        ...
        'cooking_class_order_quantity' => array(
            'notempty' => array(
                'rule' => array('notEmpty'),
                'message' => 'The purchase quantity must not be Blank.',
            //'allowEmpty' => false,
            //'required' => false,
            //'last' => false, // Stop validation after this rule
            //'on' => 'create', // Limit validation to 'create' or 'update' operations
        ...
        'cooking_class_order_date' => array(
            'datetime' => array(
                'rule' => array('datetime'),
            //'message' => 'Your custom message here',
            //'allowEmpty' => false,
    ...
    public $belongsTo = array(
        ...
        'CookingClassDate' => array(
            ...
            'foreignKey' => 'cooking_class_date_id',
            'conditions' => '',
            'fields' => '',
            'order' => ''
        )
