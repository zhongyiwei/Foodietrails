...
<form method="post" action="<?php echo $this->webroot; ?>about/contactUs/">
    <table width="200" border="1">
        <tr>
            ...
            <td><?php   echo $this->Form->input('first_name',array('label'=>false,'div'=>false)); if (isset($validationErrorsArray['first_name'])){ echo "<div class='input text required error'>".$validationErrorsArray['first_name'][0]."</div>";};?></td>
        </tr>
        <tr>
            <td>Last Name <span style="color:red">*</span></td>
            <td><?php   echo $this->Form->input('last_name',array('label'=>false,'div'=>false)); if (isset($validationErrorsArray['last_name'])){ echo "<div class='input text required error'>".$validationErrorsArray['last_name'][0]."</div>";};?></td>
        </tr>
        <tr>
            <td>Your E-mail <span style="color:red">*</span></td>
            <td><?php   echo $this->Form->input('email',array('label'=>false,'div'=>false)); if (isset($validationErrorsArray['email'])){ echo "<div class='input text required error'>".$validationErrorsArray['email'][0]."</div>";};?></td>
        </tr>
        <tr>
            <td>Phone </td>
        ...
        <tr>
           ...
           echo $this->Form->select('wantto',$options,array('label'=>false,'div'=>false,'multiple'=>'checkbox')); ?></td>
        </tr>
        <tr>
            <td>Your Message <span style="color:red">*</span></td>
            <td><?php   echo $this->Form->input('message',array('label'=>false,'div'=>false,'type'=>'textarea')); if (isset($validationErrorsArray['message'])){ echo "<div class='input text required error'>".$validationErrorsArray['message'][0]."</div>";};?></td>
        </tr>
        <tr>
            <td colspan="2">
                <div class="<?php if (isset($Error)){echo $Error[1];}?>" style="padding:0px;margin-bottom: 0px">
                    <?php
