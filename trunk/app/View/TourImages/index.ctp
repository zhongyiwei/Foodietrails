<div class="tourImages index">
	<h2><?php echo __('Tour Images'); ?></h2>
	...
	<tr>
		<td><?php echo h($tourImage['TourImage']['id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($tourImage['Tour']['id'], array('controller' => 'tours', 'action' => 'view', $tourImage['Tour']['id'])); ?>
		</td>
		<td><?php echo h($tourImage['TourImage']['tour_name']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $tourImage['TourImage']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $tourImage['TourImage']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $tourImage['TourImage']['id']), null, __('Are you sure you want to delete # %s?', $tourImage['TourImage']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
