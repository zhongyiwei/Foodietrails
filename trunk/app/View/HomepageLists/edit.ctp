...
<li><?php echo $this->Form->postLink(__('Delete this List'), array('action' => 'delete', $this->Form->value('HomepageList.id')), null, __('Are you sure you want to delete this list?')); ?></li>
<?php
$this->end();
