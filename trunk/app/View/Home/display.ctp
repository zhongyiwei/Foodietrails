...
echo $description;
?></span> <a href="" id="" style="font-size:11px; text-decoration:underline; color:blue; cursor:pointer">Read More</a> <br>
                ...
                <div class="price"><span style="font-size: 16px;">from </span><br>
                    AU$ <?php echo $tourData[0]['Tour']['tour_price_per_certificae']; ?><br>
                    <br>
                </div>
                <div style="clear:both;"></div>
            </div>
        </td>
        <td rowspan="<?php echo count($tourData); ?>">&nbsp;</td>
        <td rowspan="<?php echo count($tourData); ?>" style="vertical-align:top">
            <div class="sidetab">
    ...
    echo $description;
        ?></span> <a href="" id="" style="font-size:11px; text-decoration:underline; color:blue; cursor:pointer">Read More</a> <br>
                    ...
                    <div class="price"><span style="font-size: 16px;">from </span><br>
                        AU$ <?php echo $tourData[$i]['Tour']['tour_price_per_certificae']; ?><br>
                        <br>
                    </div>
                    <div style="clear:both;"></div>
                </div></td>
