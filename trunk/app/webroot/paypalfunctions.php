...
$API_UserName = "tours_api1.foodietrails.com.au";
$API_Password = "879Y2YJZNB46GK7B";
$API_Signature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AF6030ROUhGr7GLAyr632FMBql64";
...
function CallShortcutExpressCheckout($paymentAmount, $currencyCodeType, $paymentType, $returnURL, $cancelURL) {
    ...
    $nvpstr = $nvpstr . "&L_PAYMENTREQUEST_0_NAME0=" . "Foodie Trails Product";
    $nvpstr = $nvpstr . "&L_PAYMENTREQUEST_0_NUMBER0=" . "";
    $nvpstr = $nvpstr . " &L_PAYMENTREQUEST_0_DESC0=" . "Here shows the total amount of price required to purchase the product you bought in Foodie Trails";
    $nvpstr = $nvpstr . "&L_PAYMENTREQUEST_0_AMT0=" . $paymentAmount;

    setcookie("currencyCodeType", $currencyCodeType);
    setcookie("PaymentType", $paymentType);
    setcookie("Payment_Amount", $paymentAmount);
    //'--------------------------------------------------------------------------------------------------------------- 
