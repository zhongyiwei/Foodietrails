...
class AboutusPagesController extends AppController {
    ...
    public function add() {
        if ($this->request->is('post')) {
            ...
            if ($this->AboutusPage->save($this->request->data)) {
                $this->Session->setFlash(__('The about us page has been saved'));
                $this->redirect(array('action' => 'index'));
            } else {
                $this->Session->setFlash(__('The about us page could not be saved. Please, try again.'), 'failure-message');
            }
        }
    }
    ...
    public function edit($id = null) {
        $this->AboutusPage->id = $id;
        if (!$this->AboutusPage->exists()) {
            throw new NotFoundException(__('Invalid about us page'));
        }
    ...
    public function delete($id = null) {
        ...
        if ($this->AboutusPage->delete()) {
            $this->Session->setFlash(__('About us page deleted'));
            $this->redirect(array('action' => 'index'));
        }
        $this->Session->setFlash(__('About us page deleted unsuccessful, please delete again'), 'failure-message');
        $this->redirect(array('action' => 'index'));
    }
